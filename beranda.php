	...
	<div class="row-fluid">
		<div class="span3">
			<ul class="nav nav-list">
				...
				<li>
					<a href="katgeori/surabayatimur.php">Surabaya Timur</a>
				</li>
				<li>
	 ...
	 <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			  ...
			  <div class="modal-body">
				<div class="alert alert-info">
					<p><strong>Selamat datang di Sistem Informasi Apotek, semoga informasi yang kami berikan dapat membantu anda :)</strong></p>
					<p>Terima-Kasih.</p>
				</div>
			  </div>
