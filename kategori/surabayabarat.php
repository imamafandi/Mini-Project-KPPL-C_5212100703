...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Surabaya Barat | Sistem Informasi Apotek</title>
			...
			<div class="accordion" id="accordion-57302">
				<div class="accordion-group">
					<div class="accordion-heading">
						 <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion-57302" href="#accordion-element-213062"><h3>Surabaya Barat<h3></a>
					</div>
					<div id="accordion-element-213062" class="accordion-body collapse">
						<div class="accordion-inner">
							<a href="../kategori/surabayabarat/benowo.php">+ Benowo</a>
						</div>
						<div class="accordion-inner">
							<a href="../kategori/surabayabarat/pakal.php">+ Pakal</a>
						</div>
						<div class="accordion-inner">
							<a href="../kategori/surabayabarat/asemrowo.php">+ Asem Rowo</a>
						</div>
						<div class="accordion-inner">
							<a href="../kategori/surabayabarat/sukomanunggal.php">+ Sukomanunggal</a>
						</div><div class="accordion-inner">
							<a href="../kategori/surabayabarat/tandes.php">+ Tandes</a>
						</div>
						<div class="accordion-inner">
							<a href="../kategori/surabayabarat/sambikerep.php">+ Sambikerep</a>
						</div>
						<div class="accordion-inner">
							<a href="../kategori/surabayabarat/lakarsantri.php">+ Lakarsantri</a>
						</div>						
