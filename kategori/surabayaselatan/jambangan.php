...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Jambangan | Sistem Informasi Apotek</title>
	...
	<div class="row-fluid">
		...
		<div class="span9">
			...
			<ul class="thumbnails">
				<li class="span4">
					<div class="thumbnail">
						<img alt="300x200" src="../../assets/img/k24karahagung.png" />
						<div class="caption">
							<h4>
								Apotek K-24 Karah Agung
							</h4>
							<p>
				...
				<li class="span4">
					<div class="thumbnail">
						<img alt="300x200" src="../../assets/img/k24kebonsari.png" />
						<div class="caption">
							<h4>
								Apotek K-24 Kebonsari
							</h4>
							<p>
