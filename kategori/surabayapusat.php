...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Surabaya Pusat | Sistem Informasi Apotek</title>
          ...
          <div class="container">
            ...
            <div class="nav-collapse  navbar-responsive-collapse collapse">
              <ul class="nav">
                ...
                <li><a href="../tentang.php"> <i class="icon-bookmark"> </i> About</a></li
              </ul>
			</div>
			...
			<div class="accordion" id="accordion-57302">
				<div class="accordion-group">
					<div class="accordion-heading">
						 <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion-57302" href="#accordion-element-213062"><h3>Surabaya Pusat<h3></a>
					</div>
					<div id="accordion-element-213062" class="accordion-body collapse">
						<div class="accordion-inner">
							<a href="../kategori/surabayapusat/tegalsari.php">+ Tegalsari</a>
						</div>
						<div class="accordion-inner">
							<a href="../kategori/surabayapusat/simokerto.php">+ Simokerto</a>
						</div>
						<div class="accordion-inner">
							<a href="../kategori/surabayapusat/genteng.php">+ Genteng</a>
						</div>
						<div class="accordion-inner">	
							<a href="../kategori/surabayapusat/bubutan.php">+ Bubutan</a>
						</div>
