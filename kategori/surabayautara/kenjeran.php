...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Kenjeran | Sistem Informasi Apotek</title>
        ...
        <div class="navbar-inner">
          <div class="container">
            ...
            <div class="nav-collapse  navbar-responsive-collapse collapse">
              <ul class="nav">
                <li ><a href="../../php/home.php"><i class="icon-home"></i> Home</a></li>
...
<div class="container">
	...
	<div class="row-fluid">
		...
		<div class="span9">
			...
			<center><h4> Maaf! <h4></center>
			<center><h4> Informasi Apotek didaerah ini belum tersedia...:( <h4></center><br>
