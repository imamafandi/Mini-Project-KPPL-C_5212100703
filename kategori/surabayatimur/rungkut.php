...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Rungkut | Sistem Informasi Apotek</title>
	...
	<div class="row-fluid">
		...
		<div class="span9">
			...
			<ul class="thumbnails">
				<li class="span4">
					<div class="thumbnail">
						<img alt="300x200" src="../../assets/img/k24pandugo.png" />
						<div class="caption">
							<h4>
								Apotek K-24 Pandugo
							</h4>
				...
				<li class="span4">
					<div class="thumbnail">
						<img alt="300x200" src="../../assets/img/k24rungkut.png" />
						<div class="caption">
							<h4>
								Apotek K-24 Rungkut Asri
							</h4>
							<p>
