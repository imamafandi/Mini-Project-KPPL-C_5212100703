...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Mulyorejo | Sistem Informasi Apotek</title>
	...
	<div class="row-fluid">
		...
		<div class="span9">
			...
			<ul class="thumbnails">
				<li class="span4">
					<div class="thumbnail">
						<img alt="300x200" src="../../assets/img/k24boulevard.png" />
						<div class="caption">
							<h4>
								Apotek K-24 Boulevard
							</h4>
							<p>
				...
				<li class="span4">
					<div class="thumbnail">
						<img alt="300x200" src="../../assets/img/k24mulyosari.png" />
						<div class="caption">
							<h4>
								Apotek K-24 Mulyosari
							</h4>
							<p>
