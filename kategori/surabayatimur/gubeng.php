...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Gubeng | Sistem Informasi Apotek</title>
	...
	<div class="row-fluid">
		...
		<div class="span9">
			...
			<ul class="thumbnails">
				<li class="span4">
					<div class="thumbnail">
						<img alt="300x200" src="../../assets/img/k24dharmahusada.png" />
						<div class="caption">
							<h4>
								Apotek K-24 Dharmahusada
							</h4>
							<p>
				...
				<li class="span4">
					<div class="thumbnail">
						<img alt="300x200" src="../../assets/img/pucang.png" />
						<div class="caption">
							<h4>
								Apotek K-24 Pucang
							</h4>
