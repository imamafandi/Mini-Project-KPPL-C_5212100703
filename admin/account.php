...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title> Account | Sistem Informasi Apotek</title>
          ...
          <div class="container">
            ...
            <div class="nav-collapse  navbar-responsive-collapse collapse">
              <ul class="nav">
                ...
                <li class="active"><a href="account.php"> <i class="icon-bookmark"> </i> Account </a></li>
		...
		<div class="span3">
				<ul class="nav nav-list">
					<li class="active">
						...
						<li >
							<a href="formchangepass.php">Change Password</a>
						</li>
						
						<li>
							<a href="lihat_member.php">List Member</a>
						</li>
					</ul>
				</div>
		<div class="span9">
		 
		 <center><h3> *** Selamat Datang Di Laman Admin *** </h3></center>		
		 <center><h3> Pada Halaman ini anda dapat melakukan setting, perubahan dan update data sistem </h3></center>
		 <center><a><img class="logo" src="../assets/img/apotek.png"> </a></center>
		</div>
	</div>
</div>
