<?php
	...
	include 'connect.php'; 		//hubungkan dengan connect.php untuk berhubungan dengan database
	...
	$query=mysql_query("select * from clients where username='$username' and password='$password'");	 //melakukan pengambilan data dari database untuk di cocokkan
